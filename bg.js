...
// pick color from material color palette
  var selectRandMaterialHex = materialColorPalette[Math.floor((Math.random() * 100) % 14)][Math.floor((Math.random() * 1000) % materialColorPalette.length)];
  var color = selectRandMaterialHex.toString(16);

  document.body.style.backgroundColor = color;
  document.body.style.color = idealTextColor(color);
